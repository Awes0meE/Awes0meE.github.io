...
Between Pass A and Pass B, finish the Chinese editorial pass and pass the independent `chinese-sentence-gate.md` at the entrance to Step 10. Its six categories apply only to Chinese. At Step 12, recheck the final Chinese; if a repair affects a paired passage, align the English and repeat the existing English and bilingual checks. The existing Pass B adaptation and Pass C checks remain in force, without adding a six-category English grammar gate.
...
- the same degree of certainty and attribution in retained claims, without adding boundary commentary;
