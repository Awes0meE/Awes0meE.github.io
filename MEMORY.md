...
- the `engineering-note-writer` skill validator passes; its 20-file SHA-256 manifest matches; the five baseline/revised snapshot pairs and provenance records are present.
