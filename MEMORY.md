...
- Continue future portfolio rewrites one project family at a time; no project is currently active, and the existing 21 published notes are not authorized for a bulk rewrite. Do not reopen the approved Smart Car family unless the user explicitly requests it.
