...
As of `2026-08-14`, this workspace builds on the `main` content set that removed placeholder projects and consolidated real internship / hardware material from:
