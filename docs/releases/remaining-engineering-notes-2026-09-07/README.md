...
Publication tracking: [PR #38](https://github.com/Awes0meE/Awes0meE.github.io/pull/38). Its merge state, Vercel checks and main deployment provide remote publication status. No new tag is created; the latest named tag remains `v0.9.0`. Preserve the remote `gh-pages` redirect branch.
