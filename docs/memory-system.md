...
1. Read `CODEX.md`.
2. Read `MEMORY.md`.
3. Read task-relevant docs under `docs/`.
4. Inspect the live code before making changes.
...
3. Update `docs/architecture.md` if routes, data flow, deployment, or dependencies changed.
4. Update `docs/content-workflow.md` if content operations changed.
5. Update `README.md` or `USER_GUIDE.md` if human-facing usage changed.
