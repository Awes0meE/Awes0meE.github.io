...
- 27 note source files total: 15 public and 12 suspended in the 2026-09-07 revision; the family counts below include suspended sources;
- 2 Juanyun project pages and 11 Juanyun-prefixed notes;
...
- the six approved Smart Car, counter and DIY studies are public, replacing three old note bodies and adding three new sources. Completed review copies and the three superseded backups were removed at the user's request. The other twelve suspended notes retain their sources;
- note-to-project joins and visibility use the existing loaders. The five visible note channels are Smart Car, counter, DIY Cooling, Juanyun thermal and Nanjing Turing. No route schema, dependency or application component changed for this content release;
- the Smart Car homepage now agrees with the seven decoded IR inputs. The additional DIY schematic PNG is rendered from the existing public PDF. All 84 media records and other project assets retain their previous roles;
- see `releases/engineering-notes-2026-09-07/README.md` for this release's six routes and checks, and `active-work/portfolio-copy-rewrite.md` for remaining topic work.
