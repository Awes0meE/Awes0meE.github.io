...
| `DHT11 AM2302 温湿度传感器模块小板开发任务计划书.pdf` | 1 | Public small-board planning document. Copied as `dht11-am2302-breakout-plan.pdf` with a rendered cover image. Used in the `juanyun-thermal-hardware` archive and its related DHT11 / AM2302 note. |
