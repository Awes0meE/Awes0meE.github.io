...
- Write each section before naming its concrete subject and aspect in a short heading; avoid abstract hooks and isolated moments. Each Chinese learning note may have at most one prose paragraph beginning with `我`, including the introduction. Use natural concrete openings, preserving ownership and proposed-versus-completed status; English has no numerical quota. Use precise verb-object pairings, such as working with STM32 or practicing a specific development skill.
