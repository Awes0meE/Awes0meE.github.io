...
## Account Operation Permissions / 账户操作权限
...
## Username Rules and Account Initialization / 用户名规则与账户初始化
...
## Permission Checks Before Execution / 执行前的权限检查
...
## Saving Account Data with QSettings / QSettings 账户数据保存
