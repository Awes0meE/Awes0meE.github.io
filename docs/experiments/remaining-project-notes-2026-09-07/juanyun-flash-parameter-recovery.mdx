...
## Deferred Parameter Saving / 参数的延迟保存
...
## Record Format and Validation / 记录格式与校验
...
## Flash Page Transfer and Power-Loss Recovery / Flash 换页与掉电恢复
...
## Power-Loss Tests and Flash Endurance / 掉电测试与 Flash 寿命
