...
- The homework-report excerpts on this page show the two-digit wiring, digit-splitting code, and switch logic. The original report PDF is used as source material rather than being listed as a public project file.
...
- 页面里的作业报告截图补上了两位接线、拆位代码和开关逻辑。报告 PDF 原件只作为整理时的源材料使用，不作为公开项目文件列出。
