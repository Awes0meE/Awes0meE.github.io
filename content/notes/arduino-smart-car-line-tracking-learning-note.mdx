...
如果继续调这辆车，我会把左右轮的目标 rpm、测得的 rpm 和实际 PWM 放在一起看，再记录电池带载时的电压。这样一来，遇到轮子偏慢，就能继续追问，是驱动已经给满了，还是轮速读数更新得太慢。供电和测速在这里接到了一起。我现在再看一个电机控制函数，会自然地沿着它往两边找，一边找电流怎样经过电机，另一边找车轮怎样把实际运动反馈给程序。
