...
## Manual Commands and Automatic Control / 手动指令与自动控制
...
## Control Periods and Operating Modes / 控制周期与运行模式
...
## Superheat Calculation and EEV Control / 过热度计算与 EEV 控制
...
## Protection Logic and Startup Sequence / 保护逻辑与启动顺序
...
## Test-Team Feedback and Parameter Calibration / 测试团队反馈与参数标定
